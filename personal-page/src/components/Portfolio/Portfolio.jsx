...
const Portfolio = () => {
    return (
        <Container id="portfolioPage-main">
            ...
            <div>
                <Container className="stylizedSec">
                    <div>
                        <h2>Shine & Find</h2>
                        <p>
                    ...
                    <a href="https://frances0688.github.io/ShineAndFind/" target="_blank"><Image src="./src/assets/images/Shine&Find.png" alt="Shine and find image"/></a>
                </Container>
                <Container className="stylizedSec">
                    <div>
                        <h2>PawKedarnos</h2>
                    ...
                    <a
                        ...
                        alt="PawKedarnos website image"/></a>
                </Container>
                <Container className="stylizedSec">
                    <div>
                    ...
                    <a href="http://primetechsols.com/" target="_blank"><Image src="./src/assets/images/PrimeTech.png" alt="PrimeTech website image"/></a>
                </Container>
            </div>
        </Container>
    )
